...
class TestCustomAPI:
    ...
    @pytest.mark.custom_id
    @pytest.mark.delete
    def test_delete_by_id(self, ent_api):
        resp = ent_api.delete_by_id(284)
        AssertionsApi.assert_status_code(204, resp.status_code)
    ...
    @pytest.mark.custom_id
    @pytest.mark.get
    def test_get_by_id(self, ent_api):
        status_code, title = ent_api.get_msg_response_by_id(286)
        AssertionsApi.assert_status_code(200, status_code)
        AssertionsApi.check_title_is_right(title)
    ...
    @pytest.mark.custom_id
    @pytest.mark.patch
    def test_patch_by_id(self, ent_api):
        status_code = ent_api.patch_by_id(EMREQ0, 289)
        AssertionsApi.assert_status_code(204, status_code)
